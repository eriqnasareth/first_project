...
\ProvidesPackage{capa}{[}2014/09/01 Criacao desta customizacao do
abnTeX2{]}

\% alterando a capa \renewcommand{\imprimircapa}{%
  \begin{capa}%
    \center
...
\pandocbounded{\includegraphics[keepaspectratio]{teste_files/figure-latex/pressure-1.pdf}}
